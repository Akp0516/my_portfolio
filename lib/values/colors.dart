...
class AppColors {
  ...
  static const Color viaduct = Color(0xF00FB02D);

  static const Color faircado = Color(0xFFD35C12);
  static const Color faircadoSelectedNavTitle = Color(0xFF7004E3);
  static const Color faircadoAppLogo = Color(0xFFD35C12);
  static const Color oracle = Color(0xFF6A53A1);
  static const Color oracleNavTitle = Color(0xFF050505);
  static const Color oracleSelectedNavTitle = Color(0xFF7704D5);
  static const Color oracleAppLogo = Color(0xFF011478);
}
