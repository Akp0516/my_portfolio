...
class _ProjectItemLgState extends State<ProjectItemLg>
  ...
  Widget build(BuildContext context) {
    ...
    // of the button
    double positionOfColoredContainer = positionOfButton + (heightOfButton / 4);
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              right: assignWidth(context, 0.05),
              child: Opacity(
                opacity: 0.6,
            ...
            Positioned(
              top: positionOfButton + 110, //places button
              right: assignWidth(context, 0.1) + 130,
